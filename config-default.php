...
define('LEGAL_CASE_STAGES',['Investigation (Jaanch)','Allegation (Prasangyan)','Summon','Bailable Warrant','Arrest Warrent','MAFRUR','CHIEF','Evidance / JIRAH, (BAYAN PARIVADI)','BAYAN MUJRIM','Debate','Order','Finalised']);
