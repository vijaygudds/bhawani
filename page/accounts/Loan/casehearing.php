...
class page_accounts_Loan_casehearing extends Page {
	...
	function init(){
		...
		$crud->setModel($m,['account_id','name','bccs_file_no','court','autorised_person','amount','case_type','stage','case_on','file_verified_by','advocate','remarks'],['account','name','bccs_file_no','court','autorised_person','amount','case_type','legalcasehearing_stage','case_on','file_verified_by','advocate','remarks','legal_filing_date','last_hearing_date','owner','account_guarantor','PhoneNos','PermanentAddress']);
