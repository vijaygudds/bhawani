...
class page_accounts_SM extends Page {
	function init(){
		...
		$crud->setModel($account_Default_model,array('AccountNumber','Amount','member_id','scheme_id','Nominee','RelationWithNominee','MinorNomineeParentName','NomineeAge','ActiveStatus','sig_image_id'),array('AccountNumber','created_at','member','father_name','branch','scheme','ActiveStatus'));
